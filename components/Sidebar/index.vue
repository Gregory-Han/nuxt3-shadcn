    ...
    <div class="hidden lg:flex w-[250px] h-screen flex-col justify-between border-r">
      ...
      <div class="p-4">
        <div class="flex items-center gap-2 text-black cursor-pointer hover:bg-neutral-50 rounded p-2">
          <div class="bg-green-500 h-10 w-10 rounded-full flex items-center justify-center font-bold text-white">{{ name[0].toUpperCase() }}</div>
